...
<head>
    ...
    <style>
        ...
        .catalogo-hero-content { position: relative; z-index: 1; }
        .catalogo-hero-icon {
            width: 64px;
            height: 64px;
        ...
        .catalogo-count strong { color: var(--color-texto); }
        ...
        .curso-meta-top { flex: 1; min-width: 0; }
        .curso-categoria {
            display: inline-flex;
            align-items: center;
            gap: 5px;
        ...
        @media (max-width: 768px) {
            .catalogo-hero { padding: 48px 20px 44px; }
            .catalogo-main { padding: 0 14px 48px; }
                ...
                <c:forEach var="curso" items="${cursos}" varStatus="idx">
                    <article class="curso-card fade-in"
                        ...
                        <div class="curso-divider" aria-hidden="true"></div>
                            ...
                            <%-- Footer: instructor + módulos --%>
                        <div class="curso-card-footer">
                            <div class="curso-instructor">
                                <div class="instructor-avatar" aria-hidden="true">
                                        <%-- Inicial del instructor --%>
                                    <c:choose>
                                        <c:when test="${not empty curso.nombreCreador()}">
                                            ${fn:substring(curso.nombreCreador(), 0, 1)}
                                        </c:when>
                                ...
                                <div class="instructor-info">
                                    ...
                                    <p class="instructor-name">
                                        <c:out value="${curso.nombreCreador()}"/>
                                        <c:out value="${curso.apellidoCreador()}"/>
                                    </p>
                                </div>
                            </div>
                            <span class="curso-modulos-badge">
                                ...
                                <c:choose>
                                    <c:when test="${not empty curso.modulos}">
                                        ${curso.numeroModulos()} módulo${curso.numeroModulos() != 1 ? 's' : ''}
                                    </c:when>
                                    <c:otherwise>Sin módulos</c:otherwise>
                                </c:choose>
                            </span>
                        </div>
